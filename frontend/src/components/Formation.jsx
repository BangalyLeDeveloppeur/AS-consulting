...
import styloImg from "../assets/image/stylo.webp";
const Formation = () => {
  return (
    <div className="Compta">
      ...
      <div className="gestion">
        <p>
          ...
          <br />
          Les outils comptables et de gestion (logiciels de paie, ERP, tableaux
          de bord) ne doivent pas être une source de complexité. Nous les
          rendons accessibles et utiles pour tous les membres de votre
          organisation.
        </p>
      </div>
